...
updated: 2022-11-23T02:23:18.781Z
---
...
- 하지만 몇 가지 중요한 차이가 있다.
  ...
  - 클래스의 메소드는 [[enumerable(열거-가능)|enumerable(열거 가능)]] 로, [[for-of-vs-for-in]] 구문 등의 객체 열거에서 메서드는 열거하지 않는다. ([[객체(Object)|JavaScript 객체(Object)]]가 false 이다.)
