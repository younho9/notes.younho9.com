...
aliases:
  - '2020-12-15'
created: 2020-12-14T15:00:00.000Z
updated: 2022-09-06T14:00:06.039Z
---
...
- `reportWebVitals` - web-vitals를 통한 성능 측정에 사용됨
  ...
  - [Web Vitals](https://create-react-app.dev/docs/measuring-performance/#web-vitals)
...
- `setupTests.ts` - browser API를 사용하거나 Test 실행 전 global setup이 필요한경우에 사용
  ...
  - jest의 `setupFilesAfterEnv` 와 관련 - [Configuring Jest · Jest (jestjs.io)](https://jestjs.io/docs/configuration#setupfilesafterenv-array)

  - [Running Tests | Create React App (create-react-app.dev)](https://create-react-app.dev/docs/running-tests/#initializing-test-environment)
